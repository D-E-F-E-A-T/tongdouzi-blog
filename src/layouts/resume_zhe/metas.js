    ...
    <SVG x="0px" y="0px" width={'560px'} height={'350px'} viewBox="0 0 560 370" style={{margin: '0 auto'}} {...props}>
      ...
      <g fill="#32AEFF" transform="translate(190 40) rotate(0)">
        ...
        <text fill="#32AEFF" transform="translate(80 0)"
          textAnchor="start" dominantBaseline="middle" alignmentBaseline="middle" fontFamily="Titillium Web, monospace" fontSize="20" fontWeight="700">嘉兴学院（本科）</text>
      </g>
      <g fill="#32AEFF" transform="translate(190 130) rotate(0)">
        ...
        <text fill="#32AEFF" transform="translate(80 0)"
          textAnchor="start" dominantBaseline="middle" alignmentBaseline="middle" fontFamily="Titillium Web, monospace" fontSize="20" fontWeight="700">1992年10月30日</text>
      </g>
      <g fill="#32AEFF" transform="translate(190 210) rotate(0)">
        ...
        <text fill="#32AEFF" transform="translate(80 0)"
          textAnchor="start" dominantBaseline="middle" alignmentBaseline="middle" fontFamily="Titillium Web, monospace" fontSize="20" fontWeight="700">15715720656</text>
      </g>
      <g fill="#32AEFF" transform="translate(190 290) rotate(0)">
        ...
        <text fill="#32AEFF" transform="translate(80 0)"
          textAnchor="start" dominantBaseline="middle" alignmentBaseline="middle" fontFamily="Titillium Web, monospace" fontSize="24" fontWeight="700">675651003@qq.com</text>
      </g>
    </SVG>
  </Section>
)
